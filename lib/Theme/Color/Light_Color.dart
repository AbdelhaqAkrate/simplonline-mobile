...
class LightColor {
  ...
  static const Color red = Color(0xFFF31C00);
  static const Color darkRed = Color(0xFFDB1701);
  static const Color lightRed = Color.fromARGB(255, 255, 42, 42);
  static const Color lightRed1 = Color.fromARGB(151, 250, 0, 0);
